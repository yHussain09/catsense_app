catSenseApp.controller('productTypeController', function ($scope, $http, $q) {
  self = $scope;
  let url = 'http://localhost:3000/api/v1/productTypes';
  ...
  $scope.update = function (model) {
    $http.put(url + '/' + model.productTypeId, JSON.stringify(model))
      .then(function (success) {
        console.log(success);
        $scope.loadGrid();
      }, function (error) {
  ...
  $scope.delete = function (model) {
    $http.delete(url + '/' + model.productTypeId)
      .then(function (success) {
        console.log(success);
        $scope.loadGrid();
      }, function (error) {
